				...
				<div class="card">
					...
					<div class="card-body">
						<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
							<a class="nav-link active" id="product-info-tab" data-toggle="pill" href="#product-info" role="tab" aria-controls="product-info" aria-selected="true">Thông tin</a>
							<a class="nav-link" id="product-attribute-tab" data-toggle="pill" href="#product-attribute" role="tab" aria-controls="product-attribute" aria-selected="false">Thuộc tính</a>
							<a class="nav-link" id="product-content-tab" data-toggle="pill" href="#product-content" role="tab" aria-controls="product-content" aria-selected="false">Nội dung</a>
						</div>
					</div>
				</div>
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="form-group">
									...
									<textarea class="form-control @error('content') is-invalid @enderror" name="content" id="content" rows="30" placeholder="Nhập mô tả"></textarea>
