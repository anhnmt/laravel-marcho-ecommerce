					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="form-group">
								...
								<textarea class="form-control @error('body') is-invalid @enderror" name="body" id="body" rows="30" placeholder="Nhập mô tả">{{ $product->body }}</textarea>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="form-group">
								...
								<input type="text" class="form-control @error('quantity') is-invalid @enderror" name="quantity" id="quantity" placeholder="Nhập số lượng" value="{{ $product->quantity }}">
